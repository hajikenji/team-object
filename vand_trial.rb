...
#   COLA_STODK = 5
  ...
  def check_juice_info
    @juice_variation.each_value do |name|
  ...
  def buy_juice(simbol_juice_name)
    shortcut_juice_statement(simbol_juice_name)
    if @juice_price <= @slot_money && @stock != 0
      @juice_variation[simbol_juice_name][:stock] -= 1 ##!!!
...
#require '/Users/hajirokenji/workspace/ruby/studyruby/vand_trial.rb'